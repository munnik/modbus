...
type ClientConfiguration struct {
	...
	RS485Enabled bool
	// RS485 delay RTS prior to send
	RS485DelayRtsBeforeSend time.Duration
	// RS485 delay RTS after send
	RS485DelayRtsAfterSend time.Duration
	// RS485 set RTS high during send
	RS485RtsHighDuringSend bool
	// RS485 set RTS high after send
...
func (mc *ModbusClient) Open() (err error) {
	...
	case modbusRTU:
		rs485Config := serial.RS485Config{
			Enabled:            mc.conf.RS485Enabled,
			DelayRtsBeforeSend: mc.conf.RS485DelayRtsBeforeSend,
			DelayRtsAfterSend:  mc.conf.RS485DelayRtsAfterSend,
			RtsHighDuringSend:  mc.conf.RS485RtsHighDuringSend,
			RtsHighAfterSend:   mc.conf.RS485RtsHighAfterSend,
			RxDuringTx:         mc.conf.RS485RxDuringTx,
		}
